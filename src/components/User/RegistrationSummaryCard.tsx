...
} from '../../configs/ValidationRules/RegistrationTypes'
...
const RegistrationSummaryCard = ({ child, handleUpdateStoredChild, childIdx }: Props) => {
  ...
  const { validations, setInitialValidationValues } = useRegisterValidation(input, touched)
  ...
  const handleKeyDown = (e, key: string, value: string | number, childIdx: number): void => {
    if (e.key === 'Enter') {
                ...
                <dd className='mt-1 flex text-sm text-gray-900 sm:col-span-2 sm:mt-0'>
                  ...
                  >
                    <Input
                      ...
                      handleOnBlur={e => handleOnBlur(e.target)}
                      touched={touched}
